...
export const metadata: Metadata = {
  ...
  title: {
    default: "계산허브 — 연봉·퇴직금·세금·대출 계산기 모음",
    template: "%s | 계산허브",
  },
  description:
    "연봉 실수령액, 퇴직금, 주휴수당, 취득세, 주담대, 전세대출, 종합소득세 등 한국인의 생활 계산기를 한곳에서. 2026년 최신 기준 무료 제공.",
  keywords: ["연봉 실수령액", "퇴직금 계산기", "주휴수당", "취득세", "주담대 계산기", "종합소득세", "계산기"],
  authors: [{ name: "계산허브" }],
  openGraph: {
    type: "website",
    locale: "ko_KR",
      ...
      <body className="min-h-full flex flex-col bg-gray-50 text-gray-900">
        <header className="bg-white border-b border-gray-200 sticky top-0 z-10">
          <div className="max-w-4xl mx-auto px-4 py-3 flex items-center justify-between">
            <a href="/" className="text-lg font-bold text-blue-600">계산허브</a>
        ...
        <footer className="bg-white border-t border-gray-200 mt-10">
          <div className="max-w-4xl mx-auto px-4 py-6 text-sm text-gray-500 flex flex-wrap gap-4 justify-between">
            <span>© 2026 계산허브. 계산 결과는 참고용입니다.</span>
